(function () {
  ...
  const DEFAULT_PASSWORD = "iute2026";
  ...
  function renderHero(data) {
    ...
    title.textContent = data.hero.title || defaults.hero.title;
    description.textContent = data.hero.description || defaults.hero.description;
  }
  ...
  if (document.getElementById("cardGrid")) renderPublicPage();
})();
